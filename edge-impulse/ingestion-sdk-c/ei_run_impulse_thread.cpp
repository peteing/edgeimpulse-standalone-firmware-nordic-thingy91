...
static void process_results(ei_impulse_result_t* result){
    ...
    ei_nnlabels_t label_index =NNDEFAULT_LABEL;


    for(size_t i =0 ; i < EI_CLASSIFIER_LABEL_COUNT; i++){

        if(result->classification[i].value > ((float)CONFIG_LABEL_THRESHOLD/100))
            label_index = (ei_nnlabels_t)i;  // effectively voting up the last highest label
    ...
    switch (label_index){
        ...
        case NNLABEL_1:
            ...
            #ifdef CONFIG_LABEL_1_1_RED_LED
                EI_LED_OFF;
                EI_LED_RED; 
            #elif CONFIG_LABEL_1_1_GREEN_LED
                EI_LED_OFF;
                EI_LED_GREEN;
            #elif CONFIG_LABEL_1_1_BLUE_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_1_1_MAGENTA_LED
                EI_LED_OFF;
                EI_LED_MAGENTA;
            #elif CONFIG_LABEL_1_1_YELLOW_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_1_1_NONE
                EI_LED_OFF;
            #endif
          
            #ifdef CONFIG_LABEL_1_2_BUZZER_HIGH
                BUZZER_OFF;
                BUZZER_HIGH; 
            #elif CONFIG_LABEL_1_2_BUZZER_MID
                BUZZER_OFF;
                BUZZER_MID;
            #elif CONFIG_LABEL_1_2_BUZZER_LOW
                BUZZER_OFF;
                BUZZER_LOW;
            #elif CONFIG_LABEL_1_2_NONE
                BUZZER_OFF;
        ...
        case NNLABEL_2:
             #ifdef CONFIG_LABEL_2_1_RED_LED
                EI_LED_OFF;
                EI_LED_RED; 
            #elif CONFIG_LABEL_2_1_GREEN_LED
                EI_LED_OFF;
                EI_LED_GREEN;
            #elif CONFIG_LABEL_2_1_BLUE_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_2_1_MAGENTA_LED
                EI_LED_OFF;
                EI_LED_MAGENTA;
            #elif CONFIG_LABEL_2_1_YELLOW_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_2_1_NONE
                EI_LED_OFF;
            #endif
          
            #ifdef CONFIG_LABEL_2_2_BUZZER_HIGH
                BUZZER_OFF;
                BUZZER_HIGH; 
            #elif CONFIG_LABEL_2_2_BUZZER_MID
                BUZZER_OFF;
                BUZZER_MID;
            #elif CONFIG_LABEL_2_2_BUZZER_LOW
                BUZZER_OFF;
                BUZZER_LOW;
            #elif CONFIG_LABEL_2_2_NONE
                BUZZER_OFF;
        ...
        case NNLABEL_3:
             #ifdef CONFIG_LABEL_3_1_RED_LED
                EI_LED_OFF;
                EI_LED_RED; 
            #elif CONFIG_LABEL_3_1_GREEN_LED
                EI_LED_OFF;
                EI_LED_GREEN;
            #elif CONFIG_LABEL_3_1_BLUE_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_3_1_MAGENTA_LED
                EI_LED_OFF;
                EI_LED_MAGENTA;
            #elif CONFIG_LABEL_3_1_YELLOW_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_3_1_NONE
                EI_LED_OFF;
            #endif
          
            #ifdef CONFIG_LABEL_3_2_BUZZER_HIGH
                BUZZER_OFF;
                BUZZER_HIGH; 
            #elif CONFIG_LABEL_3_2_BUZZER_MID
                BUZZER_OFF;
                BUZZER_MID;
            #elif CONFIG_LABEL_3_2_BUZZER_LOW
                BUZZER_OFF;
                BUZZER_LOW;
            #elif CONFIG_LABEL_3_2_NONE
                BUZZER_OFF;
        ...
        case NNLABEL_4:
             #ifdef CONFIG_LABEL_4_1_RED_LED
                EI_LED_OFF;
                EI_LED_RED; 
            #elif CONFIG_LABEL_4_1_GREEN_LED
                EI_LED_OFF;
                EI_LED_GREEN;
            #elif CONFIG_LABEL_4_1_BLUE_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_4_1_MAGENTA_LED
                EI_LED_OFF;
                EI_LED_MAGENTA;
            #elif CONFIG_LABEL_4_1_YELLOW_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_4_1_NONE
                EI_LED_OFF;
            #endif
          
            #ifdef CONFIG_LABEL_4_2_BUZZER_HIGH
                BUZZER_OFF;
                BUZZER_HIGH; 
            #elif CONFIG_LABEL_4_2_BUZZER_MID
                BUZZER_OFF;
                BUZZER_MID;
            #elif CONFIG_LABEL_4_2_BUZZER_LOW
                BUZZER_OFF;
                BUZZER_LOW;
            #elif CONFIG_LABEL_4_2_NONE
                BUZZER_OFF;
        ...
        case NNLABEL_5:
             ...
             #ifdef CONFIG_LABEL_5_1_RED_LED
                EI_LED_OFF;
                EI_LED_RED; 
            #elif CONFIG_LABEL_5_1_GREEN_LED
                EI_LED_OFF;
                EI_LED_GREEN;
            #elif CONFIG_LABEL_5_1_BLUE_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_5_1_MAGENTA_LED
                EI_LED_OFF;
                EI_LED_MAGENTA;
            #elif CONFIG_LABEL_5_1_YELLOW_LED
                EI_LED_OFF;
                EI_LED_BLUE;
            #elif CONFIG_LABEL_5_1_NONE
                EI_LED_OFF;
            #endif
          
            #ifdef CONFIG_LABEL_5_2_BUZZER_HIGH
                BUZZER_OFF;
                BUZZER_HIGH; 
            #elif CONFIG_LABEL_5_2_BUZZER_MID
                BUZZER_OFF;
                BUZZER_MID;
            #elif CONFIG_LABEL_5_2_BUZZER_LOW
                BUZZER_OFF;
                BUZZER_LOW;
            #elif CONFIG_LABEL_5_2_NONE
                BUZZER_OFF;
        ...
        case NNLABEL_6:
           ...
           /* If you found this add whatever custom code for your 6th label here */
...
void ei_inference_thread_custom(void* param1, void* param2, void* param3)
{
    signal_t signal;
...
#ifdef CONFIG_STANDALONE_MODE_AUTO

        ei_printf("CLI disabled...Inferencing running in Standalone AUTO Start Mode...\n");
#endif
#ifdef CONFIG_STANDALONE_MODE_BUTTON

        ei_printf("CLI disabled...Inferencing running in Standalone BUTTON Start Mode...\n");
...
K_THREAD_DEFINE(ei_inference, CONFIG_EI_INFERENCE_THREAD_STACK,
                ei_inference_thread_custom, NULL, NULL, NULL,
