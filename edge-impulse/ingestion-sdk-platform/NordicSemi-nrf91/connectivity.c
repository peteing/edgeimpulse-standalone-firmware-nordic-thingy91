...
#if defined CONIFG_MODEM_START_AUTO && ((CONFIG_STANDALONE_MODE_AUTO) || (CONFIG_STANDALONE_MODE_BUTTON))
        BUZZER_RAMP_UP;
#endif
        while (1)
        {
...
K_THREAD_DEFINE(mqtt_handler_id, STACKSIZE, mqtt_handler, NULL, NULL, NULL,PRIORITY, 0, 0);